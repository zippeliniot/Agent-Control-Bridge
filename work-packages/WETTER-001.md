...
- [x] Manuelle Pruefung ohne Konsolenfehler, beide Standorte (Ersatzverfahren, siehe Zusammenfassung)
- [x] Teil B: Befund dokumentiert (umgesetzt ODER begruendet nicht umgesetzt) - nicht umgesetzt, siehe Zusammenfassung
- [x] Scope eingehalten (nur genannte Dateien in beiden Repos)